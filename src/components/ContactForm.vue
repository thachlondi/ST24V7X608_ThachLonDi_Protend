<template>
    <Form @submit="submitContact" :validation-schema="contactFormSchema">
        ...
        <div class="form-group">
            <label><strong>Sở thích yêu thích:</strong></label>
            <div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="sport" value="Thể thao" v-model="contactLocal.favorite" />
                    <label class="form-check-label" for="sport">Thể thao</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="music" value="Âm nhạc" v-model="contactLocal.favorite" />
                    <label class="form-check-label" for="music">Âm nhạc</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="elec" value="Điện tử" v-model="contactLocal.favorite" />
                    <label class="form-check-label" for="elec">Điện tử</label>
                </div>
            </div>
        </div>
...
export default {
    ...
    data() {
        ...
        return {
            // CẬP NHẬT: Khởi tạo favorite là mảng để v-model checkbox hoạt động đúng
            contactLocal: { 
                ...this.contact,
